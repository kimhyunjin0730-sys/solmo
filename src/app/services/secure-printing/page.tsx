...
export const metadata: Metadata = {
  title: '보안프린트 구축',
  description:
    'xSecuritas 워터마크와 사원증 인증으로 종이 문서 유출을 차단하는 보안 출력 시스템.',
};
    ...
    <div className="space-y-12 pb-10">
      <header className="max-w-4xl">
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mb-3 leading-snug">
          종이 문서를 통한 정보 유출,{' '}
          <span className="text-blue-600">스마트 보안 출력</span>으로 원천
          차단합니다.
        </h2>
        <p className="text-slate-500 font-medium text-sm leading-relaxed">
          자체 솔루션 xSecuritas 기반의 스크린 및 출력물 워터마크 기술을 적용하여
      ...
      <section className="bg-white border border-slate-100 rounded-3xl p-6 sm:p-10 lg:p-12">
        <div className="mb-8">
          ...
          <p className="text-slate-500 font-medium text-sm mt-2">
            사용자 → Print 서버 → 사원증 인증 → 어느 복합기에서든 출력. 모든
            작업은 보안·관제 서버에 자동 기록됩니다.
          </p>
        </div>
      ...
      <section className="bg-slate-900 text-white rounded-[2rem] sm:rounded-[2.5rem] p-8 sm:p-12 lg:p-14 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-600/15 rounded-full blur-[120px] pointer-events-none" />
        <div className="max-w-2xl relative z-10">
          ...
          <p className="text-base font-medium leading-relaxed mb-8 text-white/70">
            기업 환경의 복합기 구성을 그대로 유지하면서 독보적인 보안 레이어를
            추가할 수 있는 것이 솔모만의 차별화된 기술력입니다.
          </p>
          <ul className="space-y-3 text-sm font-bold text-white/60">
            <li className="flex items-center gap-3">
              <span className="text-blue-400">✔</span> 하이브리드 환경(사내외)
              완벽 지원
            </li>
            <li className="flex items-center gap-3">
              <span className="text-blue-400">✔</span> 사용자 보안 의식 제고 및
              심리적 억제 효과
            </li>
            <li className="flex items-center gap-3">
              <span className="text-blue-400">✔</span> 법적 준거성(DLP) 대응
              체계 완성
            </li>
          </ul>
        </div>
...
function FeatureCard({
  ...
  return (
    <div className="p-7 sm:p-9 rounded-3xl bg-white border border-slate-100 hover:border-blue-200 hover:shadow-md hover:-translate-y-1 transition-all group">
      ...
      <h4 className="text-lg sm:text-xl font-extrabold text-slate-900 mb-3 tracking-tight">
        {title}
      </h4>
      <p className="text-sm font-medium text-slate-500 leading-relaxed mb-5">
        {desc}
      </p>
      <div className="w-10 h-1 bg-blue-500 rounded-full group-hover:w-full transition-all" />
    </div>
  );
}
      ...
      >
        ...
        <g>
          <rect
            ...
            strokeWidth="1.5"
          />
          <text x="100" y="115" textAnchor="middle" fontSize="32">
            👤
          </text>
          <text
            x="100"
        ...
        <g>
          <rect
            ...
            strokeWidth="2"
          />
          <text x="430" y="115" textAnchor="middle" fontSize="28">
            🖨
          </text>
          <text
            x="430"
        ...
        {[
          { y: 60, label: 'A지역 (10층)', l1: '사원증 인증 출력', l2: '📤 결과물 출력' },
          { y: 200, label: 'B지역 (7층)', l1: '복사 / 이력 저장', l2: '📷 이미지 자동 백업' },
          { y: 340, label: 'C지역 (1층)', l1: '스캔 / 팩스 / E-mail', l2: '📨 송신 이력 추적' },
        ].map((m) => (
          <g key={m.label}>
            <rect
              x="700"
            ...
            <circle cx="755" cy={m.y + 75} r="5" fill="#10b981" />
          </g>
        ))}

        <path
          d="M 510 110 Q 600 90 695 105"
          stroke="#f43f5e"
          strokeWidth="2.5"
          fill="none"
          markerEnd="url(#arrowRose)"
        ...
        <g>
          <rect
            ...
            strokeWidth="1.5"
          />
          <text x="115" y="415" textAnchor="middle" fontSize="28">
            🧑‍💼
          </text>
          <text
            x="115"
